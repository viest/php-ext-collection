...
#define PHP_VCOLLECT_VERSION "0.1.0" /* Replace with version number for your extension */
...
ZEND_BEGIN_MODULE_GLOBALS(vcollect)
	zend_long  global_value;
	char *global_string;
ZEND_END_MODULE_GLOBALS(vcollect)
*/

/* Always refer to the globals in your function as VCOLLECT_G(variable).
